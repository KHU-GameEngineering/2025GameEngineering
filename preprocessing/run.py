...
from src.utils.infer_util import resize_foreground, save_video
...
parser.add_argument(
    ...
    type=int,
    default=75,
    help="Denoising sampling steps for Zero123Plus.",
)
parser.add_argument("--seed", type=int, default=42, help="Random seed.")
parser.add_argument(
    "--scale", type=float, default=1.0, help="Scale of generated object."
)
parser.add_argument(
    "--distance", type=float, default=4.5, help="Render distance for video."
)
parser.add_argument(
    "--view", type=int, default=6, choices=[4, 6], help="Number of input views."
)
parser.add_argument(
    "--no_rembg",
    action="store_true",
    help="Do NOT remove background of the input image.",
)
parser.add_argument(
    "--export_texmap",
    action="store_true",
    help="Export mesh with texture map (OBJ+MTL).",
)
parser.add_argument(
    "--save_video", action="store_true", help="Save a circular-view video."
)
...
print("Loading reconstruction model (InstantMesh LRM) ...")
...
base_cameras = get_zero123plus_input_cameras(
